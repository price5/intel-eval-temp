...
import { Trophy, Target, TrendingUp, Code2, MessageSquare, RotateCcw, CheckCircle, AlertTriangle, XCircle } from 'lucide-react';
...
interface ResultsPageProps {
  ...
  language: string;
  codeWeight: number;
  peerStatistics?: PeerStatistics | null;
  onStartNew: () => void;
}
...
export const ResultsPage: React.FC<ResultsPageProps> = ({
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription className="text-lg mt-1">
                Your comprehensive coding evaluation is complete
              </CardDescription>
            </div>
      ...
      {/* Peer Comparison Section - Only for assessments with statistics */}
      {peerStatistics && peerStatistics.totalSubmissions >= 4 && (
        <Card className="bg-card/50 backdrop-blur-sm">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
            ...
            <CardDescription>
              How your performance compares to {peerStatistics.totalSubmissions} other students
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid gap-4">
              <div className="grid grid-cols-3 gap-4">
                <div className="text-center">
                  <p className="text-2xl font-bold">{Math.round(peerStatistics.userPercentile.overall)}%</p>
                  <p className="text-sm text-muted-foreground">Overall Percentile</p>
                </div>
                <div className="text-center">
                  <p className="text-2xl font-bold">{Math.round(peerStatistics.averageScores.overall)}</p>
                  <p className="text-sm text-muted-foreground">Class Average</p>
                </div>
                <div className="text-center">
                  <p className="text-2xl font-bold">{peerStatistics.userScores.overall}</p>
